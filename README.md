...
export PES_AUTHOR="prajwal hegde <PES1UG24CS593>"
make all
```
...
![Phase 1A](images1a.png)

### Screenshot 1B — `find .pes/objects -type f`

![Phase 1B](images1b.png)
...
![Phase 2A](images2a.png)

### Screenshot 2B — `xxd` of a raw tree object

![Phase 2B](images2b.png)
...
![Phase 4A](images4a.png)

### Screenshot 4B — `find .pes -type f | sort`

![Phase 4B](images4b.png)

### Screenshot 4C — Reference chain

![Phase 4C](images4c.png)
